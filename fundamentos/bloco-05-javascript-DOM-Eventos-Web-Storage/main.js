...
// Ocorre por conta do style associado a classe .tech:transform: translateY(0px);
...
myWebpage.addEventListener ('dblclick', function () {
  window.location.replace ('https://open.spotify.com/playlist/4X5VNz5tkUCeBom8IYfl8U?si=877d849333fd4d0c')
});
